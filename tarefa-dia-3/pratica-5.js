...
let totalSemGorjeta = 0
let contador = 0

while (contador < receita.length){
    totalSemGorjeta +=  receita[contador].valor
    contador ++
}

console.log(`Total de vendas sem gorjeta: ${totalSemGorjeta}`)

/* ----------------------------------------------------------------------------- */
/* PROBLEMA 2: Qual o valor total de vendas incluindo a gorjeta? --------------- */
//COLOQUE SUA SOLUÇÃO AQUI

let totalComGorjeta = 0
let contador2 = 0

while (contador2 < receita.length){
    totalComGorjeta += receita[contador2].valor + receita[contador2].gorjeta
    contador2 ++
}
console.log(`Total de vendas com gorjeta: ${totalComGorjeta}`)
/* ----------------------------------------------------------------------------- */
/* PROBLEMA 3: Quantas vendas foram abaixo de 50 reais? ----------------------- */
//COLOQUE SUA SOLUÇÃO AQUI
let totalAbaixo50Reais = 0
let contador3 = 0

while (contador3 < receita.length){
    const totalVenda = receita[contador3].valor + receita[contador3].gorjeta
...
console.log(`Total de vendas abaixo de 50 reais: ${totalAbaixo50Reais}`)
/* ----------------------------------------------------------------------------- */